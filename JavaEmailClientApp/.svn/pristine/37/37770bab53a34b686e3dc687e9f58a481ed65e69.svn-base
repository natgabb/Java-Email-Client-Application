...
/**
 * This controller care of sending mail using SMTP.
 * 
...
public class MailSendController {
	...
	/*
	 * Messages that are not being sent with a gmail will use this method.
	 */
	...
	/**
	 * The SMTP autheticator if the mail server requires it.
	 */
	...
	/*
	 * Messages that are being sent with a gmail account will use this method.
	 */
